...
public:
	...
	//씬매니저에서 사용
	void FrameRender_Title(HDC hdc, int destX, int destY,
		int currentKeyFrameX, int currentKeyFrameY, float scale = 1.0f);
	void FrameRender_Ending(HDC hdc, int destX, int destY, int currentKeyFrameX, int currentKeyFrameY, float scale);
	void FrameRenderHP(HDC hdc, int destX, int destY,
		int currentKeyFrameX, int currentKeyFrameY, float scale = 1.0f, bool isHp = false);
	...
	//맵스크롤
	void ScrollRender(HDC hdc, int Mapsize_y);
